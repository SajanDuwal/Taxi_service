...
class VehicleTypeNewAdapter(private val vehicleTypeNewArrayList: ArrayList<String>) :
    RecyclerView.Adapter<VehicleTypeNewAdapter.ViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return vehicleTypeNewArrayList.size
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.tvTitle.text = vehicleTypeNewArrayList[position]
        if (position % 2 == 0) {
